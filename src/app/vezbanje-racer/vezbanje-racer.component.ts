...
export class VezbanjeRacerComponent {
  ...
  public characterMap = new Map([
    ...
    ['п', 'p'], ['ш', 'š'], ['ђ', 'đ'], ['а', 'a'], ['с', 's'], ['д', 'd'], ['ф', 'f'],
    ['г', 'g'], ['х', 'h'], ['ј', 'j'], ['к', 'k'], ['л', 'l'], ['ч', 'č'], ['ћ', 'ć'], ['ж', 'ž'], ['џ', 'dž'],
    ['ц', 'c'], ['в', 'v'], ['б', 'b'], ['н', 'n'], ['м', 'm'], ['Љ', 'Lj'], ['Њ', 'Nj'], ['Е', 'E'], ['Р', 'R'],
    ['Т', 'T'], ['З', 'Z'], ['У', 'U'], ['И', 'I'], ['О', 'O'], ['П', 'P'], ['Ш', 'Š'], ['Ђ', 'Đ'], ['А', 'A'],
    ['С', 'S'], ['Д', 'D'], ['Ф', 'F'], ['Г', 'G'], ['Х', 'H'], ['Ј', 'J'], ['К', 'K'], ['Л', 'L'], ['Ч', 'Č'],
    ['Ћ', 'Ć'], ['Ж', 'Ž'], ['Џ', 'Dž'], ['Ц', 'C'], ['В', 'V'], ['Б', 'B'], ['Н', 'N'], ['М', 'M'], [' ', ' ']
  ]);
